...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
    ...
    return (
        <div className="min-h-screen bg-slate-50 flex font-sans overflow-hidden h-screen" dir="ltr">
                ...
                <header className="h-20 bg-white/80 backdrop-blur-md border-b border-slate-200 px-6 flex items-center justify-between sticky top-0 z-40 shrink-0">
                    <div className="flex-1 max-w-xl hidden md:block">
                        <div className="relative group">
                            ...
                            <input 
                                type="text" 
                                placeholder="Search leads, hospitals, or tags..." 
                                className="w-full bg-slate-50 border-none rounded-2xl py-3 pl-12 pr-4 text-sm focus:ring-2 focus:ring-primary/10 transition-all"
                            />
                        </div>
                    </div>
